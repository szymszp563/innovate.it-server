...
public class ServerBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void loadDara() {
        ...
        Place place1 = Place.builder().longitude("50.2540449").latitude("19.0593588").name("Katowice").build();
        Place place2 = Place.builder().longitude("50.2540449").latitude("19.0593588").name("Katowice").build();
